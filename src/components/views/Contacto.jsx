          ...
          <Form className="titulos contenedorFormulario p-4">
            ...
            <Form.Group className="mb-2">
              ...
              <Form.Select>
                ...
                <option value="consulta">Clínica general</option>
                <option value="plan">Cirugía</option>
                <option value="madurando">Sistema de turnos</option>
                <option value="adultos">Otras consultas</option>
              </Form.Select>
            </Form.Group>
